          ...
          data.map((item, index) => {
            return (
              <div key={index} className='flex-col flex items-start justify-between md:min-h-[18vw]  rounded-xl bg-white border w-full p-8 gap-5'>
                ...
                <p className='text-left mt-2 text-[#21272A] text-xl md:text-[.9vw] font-[spaceRegualar]'>{item.desc} </p>
                </div>
                <div className='w-full flex gap-5 items-center'>
                  <div className='h-[10vw] w-[10vw] md:w-[4vw] md:h-[4vw] bg-gray-200 rounded-full flex items-center justify-center overflow-hidden'>
